...
SECRET_KEY = '@=xr-)v9r9wamg$31zsxe9fafme^out(0#kp+ihu*619m^xz!)'
...
#CORS_ALLOW_HEADERS = default_headers + ( 'Access-Control-Allow-Origin', 'Access-Control-Allow-Methods', 'Access-Control-Allow-Headers' )
